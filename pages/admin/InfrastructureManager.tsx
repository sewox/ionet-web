...
const InfrastructureManager: React.FC = () => {
    const { infraFeatures, addInfraFeature, deleteInfraFeature, techPartners, addTechPartner, deleteTechPartner } = useData();
                ...
                <div className="p-6 grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <div className="lg:col-span-2 flex flex-wrap gap-4">
                        {techPartners.map(partner => (
                            <div key={partner.id} className="flex items-center gap-3 px-4 py-3 bg-gray-50 rounded-lg border border-gray-200 relative group pr-8">
                                ...
                                <button
                                    onClick={() => deleteTechPartner(partner.id)}
                    ...
                    <div className="bg-gray-50 p-5 rounded-xl border border-gray-200 h-fit">
                        <h4 className="font-semibold text-gray-800 mb-4">Yeni Ortak Ekle</h4>
